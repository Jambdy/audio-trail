...
class _$SiteImpl implements _Site {
  ...
  @override
  String toString() {
    return 'Site(id: $id, title: $title, description: $description, coordinates: $coordinates, order: $order)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, coordinates, order);
...
abstract class _Site implements Site {
  const factory _Site(
      ...
      required final int order}) = _$SiteImpl;
